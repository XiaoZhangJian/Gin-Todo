...
// 	githubClientKey := "63c70afdd4cfd79d0783"                     //:= flag.String("client_key", "[your github client key]", "your oauth client key")
// 	githubSecretKey := "5ec0597aa6034bc4c14efe5bbfaf20693b526ada" //:= flag.String("secret_key", "[your github secret key]", "your oauth secret key")
// 	flag.Parse()
...
// 	// login handler
// 	githubHandler := auth.Github(githubClientKey, githubSecretKey, "user")
...
// 	http.HandleFunc("/mainpage", auth.SecureUser(Private2))
